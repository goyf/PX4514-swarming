...
\begin{figure}[!htp]
		\centering
		\fbox{\includegraphics[width=0.85\linewidth]{images/Fish_Swarm.png}}
		\fbox{\includegraphics[width=0.85\linewidth]{images/Fish_NoSwarm.png}}
...
\begin{figure}[!htp]
		\centering
		\fbox{\includegraphics[width=1.02\linewidth]{images/Boid_Population.png}}
