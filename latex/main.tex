...
\begin{figure}[!htp]
		\fbox{\includegraphics[width=0.465\linewidth]{images/hunterCircleBefore.png}}
		\label{fig:swarming}
		\fbox{\includegraphics[width=0.465\linewidth]{images/hunterCircleAfter.png}}
